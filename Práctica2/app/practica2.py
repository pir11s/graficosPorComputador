...
def draw_rect_x():
    a = canvas.create_rectangle(rect_x_1,rect_x_2,rect_x_1+800,rect_x_2,fill='black',tags="rect")
...
def main_loop():
    ...
    window.after(12000,basicDraw)
    window.after(13000,draw_rect_x)
    window.after(14000,draw_ref_x)
    window.after(15000,delete_rect_x)
    window.after(16000,basicDraw)
    window.after(17000,main_loop)
